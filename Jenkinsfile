    ...
    stages {
        ...
        stage('Docker Deploy QA') {
            ...
            steps {
                ...
                sh "docker run -d -p 8085:8081 --name ninja-belt-qa -h localhost --network dd-network --ip 10.0.0.11 ${env.DOCKER_HUB_ACCOUNT}/${env.APPLICATION_NAME}-qa:${env.APPLICATION_TAG_VERSION}"
        ...
        stage('Docker Deploy PROD') {
            ...
            steps {
                ...
                sh "docker run -d -p 8086:8081 --name ninja-belt-prod -h localhost --network dd-network --ip 10.0.0.13 ${env.DOCKER_HUB_ACCOUNT}/${env.APPLICATION_NAME}-prod:${env.APPLICATION_TAG_VERSION}"
            }
        }
    }
}
